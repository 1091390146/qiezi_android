                ...
                case 3:
                    ...
                    try {
                        ...
                        if (status.equals("success")) {
                            ...
                            IntentUtils.getIntent(RegisterActivity.this, MainActivity.class);
...
//            Toast.makeText(RegisterActivity.this, "获取成功，请稍后！", Toast.LENGTH_SHORT).show();
    ...
    private void Next() {
        ...
        if (firstPassword.equals(secondPassword) ) {
            ...
            if ((phoneNum.length() == 11) && (verifyCode.length()) == 6) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        String phoneNum = phone_num.getText().toString();
                        String verifyCode = sendVerifyCode.getText().toString();
                        result_data = HttpTool.AppRegister(phoneNum, verifyCode, firstPassword);
            ...
            Toast.makeText(RegisterActivity.this,"请检查输入的密码是否正确！",Toast.LENGTH_SHORT).show();
