...
import com.example.qiezi.db.sp.UserSp;
...
public class UserInfo implements Serializable {
    ...
    public String toString() {
        return "UserInfo [userId=" + userId + ", userIdTemp=" + userIdTemp + ", userPassword=" + userPassword + ", userImg=" + userImg + ", userPhone=" + userPhone + ", userCode=" + userCode
                + ", userName=" + userName + ", userGender=" + userGender + ", userAge=" + userAge + ", userPosition=" + userPosition + ", userCityId=" + userCityId + ", userCity=" + userCity
